...
# df.plot(x='An', y='Vanzari', marker='o',lineStyles='-', color='b', label='Vanzari')
# plot.xlabel('An')
# plot.ylabel('Vanzari')
...
# data = {'Varsta':[25,30,35,40,45,50,55,30,55,60]}
# df=pd.DataFrame(data)
...
df.plot(x='An',y='Vanzari', ax=axs[0,0], marker='o', lineStyles='--', color='r', label='Vanzari')
